...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayUCheckoutPro",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC15PayUCheckoutPro9BankCodes")
...
SWIFT_CLASS("_TtC15PayUCheckoutPro12HashConstant")
...
SWIFT_CLASS("_TtC15PayUCheckoutPro15PayUCheckoutPro")
@interface PayUCheckoutPro : NSObject
+ (void)openOn:(UIViewController * _Nonnull)parentVC paymentParam:(PayUPaymentParams * _Nonnull)paymentParam config:(PayUCheckoutProConfig * _Nullable)config delegate:(id <PayUCheckoutProDelegate> _Nonnull)delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15PayUCheckoutPro21PayUCheckoutProConfig")
...
SWIFT_PROTOCOL("_TtP15PayUCheckoutPro23PayUCheckoutProDelegate_")
@protocol PayUCheckoutProDelegate
...
SWIFT_CLASS("_TtC15PayUCheckoutPro20PaymentParamConstant")
...
SWIFT_CLASS("_TtC15PayUCheckoutPro23PaymentResponseConstant")
...
SWIFT_CLASS("_TtC15PayUCheckoutPro6PopTip")

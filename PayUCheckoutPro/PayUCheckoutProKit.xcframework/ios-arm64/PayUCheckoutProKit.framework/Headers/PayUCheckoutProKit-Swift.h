...
@class PaymentOption;
SWIFT_ENUM_FWD_DECL(NSInteger, ScreenState)
@class CardBinInfo;
...
@class PayULanguage;
SWIFT_ENUM_FWD_DECL(NSInteger, PayULanguageCode)
...
- (void)getBinInfoOfCardNumber:(NSString * _Nonnull)cardNumber paymentOption:(PaymentOption * _Nullable)paymentOption shouldAutoApplyOffer:(BOOL)shouldAutoApplyOffer onCompletion:(void (^ _Nonnull)(CardBinInfo * _Nullable, NSError * _Nullable))onCompletion;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull cardSchemaType;)
+ (NSString * _Nonnull)cardSchemaType SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull enforceIbiboCode;)
+ (NSString * _Nonnull)enforceIbiboCode SWIFT_WARN_UNUSED_RESULT;

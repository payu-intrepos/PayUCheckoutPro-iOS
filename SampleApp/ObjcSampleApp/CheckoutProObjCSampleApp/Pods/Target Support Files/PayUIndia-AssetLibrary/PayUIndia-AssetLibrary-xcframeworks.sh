...
install_xcframework "${PODS_ROOT}/PayUIndia-AssetLibrary/PayUAssetLibraryKit/PayUAssetLibraryKit.xcframework" "PayUIndia-AssetLibrary" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

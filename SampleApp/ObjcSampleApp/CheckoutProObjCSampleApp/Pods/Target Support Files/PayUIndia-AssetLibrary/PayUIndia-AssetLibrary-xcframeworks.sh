...
install_xcframework "${PODS_ROOT}/PayUIndia-AssetLibrary/PayUAssetLibraryKit/PayUAssetLibraryKit.xcframework" "PayUAssetLibraryKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"

...
install_xcframework "${PODS_ROOT}/PayUIndia-Networking/Dependencies/PayUNetworkingKit.xcframework" "PayUIndia-Networking" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

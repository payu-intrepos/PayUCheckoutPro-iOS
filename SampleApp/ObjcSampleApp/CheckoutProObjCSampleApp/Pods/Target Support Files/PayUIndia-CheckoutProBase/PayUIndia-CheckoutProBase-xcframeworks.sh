...
install_xcframework "${PODS_ROOT}/PayUIndia-CheckoutProBase/PayUCheckoutProBaseKit/PayUCheckoutProBaseKit.xcframework" "PayUCheckoutProBaseKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"

...
install_xcframework "${PODS_ROOT}/PayUIndia-UPICore/Dependencies/PayUUPICoreKit.xcframework" "PayUIndia-UPICore" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"

...
install_xcframework "${PODS_ROOT}/PayUIndia-NativeOtpAssist/framework/PayUNativeOtpAssist.xcframework" "PayUIndia-NativeOtpAssist" "framework" "ios-arm64" "ios-x86_64-simulator"

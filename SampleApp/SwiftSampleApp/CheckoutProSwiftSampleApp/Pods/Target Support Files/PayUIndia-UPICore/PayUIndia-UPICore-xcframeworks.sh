...
install_xcframework "${PODS_ROOT}/PayUIndia-UPICore/Dependencies/PayUUPICoreKit.xcframework" "PayUIndia-UPICore" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

...
install_xcframework "${PODS_ROOT}/PayUIndia-CheckoutProBase/PayUCheckoutProBaseKit/PayUCheckoutProBaseKit.xcframework" "PayUCheckoutProBaseKit" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"

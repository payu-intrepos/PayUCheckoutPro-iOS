...
install_xcframework "${PODS_ROOT}/PayUIndia-CheckoutProBase/PayUCheckoutProBaseKit/PayUCheckoutProBaseKit.xcframework" "PayUIndia-CheckoutProBase" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

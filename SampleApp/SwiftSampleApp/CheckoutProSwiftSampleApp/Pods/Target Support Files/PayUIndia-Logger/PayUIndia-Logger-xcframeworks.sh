...
install_xcframework "${PODS_ROOT}/PayUIndia-Logger/Dependencies/PayULoggerKit.xcframework" "PayUIndia-Logger" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

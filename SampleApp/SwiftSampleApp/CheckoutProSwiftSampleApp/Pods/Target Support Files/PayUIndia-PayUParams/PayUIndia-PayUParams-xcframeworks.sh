...
install_xcframework "${PODS_ROOT}/PayUIndia-PayUParams/PayUParamsKit/PayUParamsKit.xcframework" "PayUIndia-PayUParams" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"

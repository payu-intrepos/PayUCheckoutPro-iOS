...
install_xcframework "${PODS_ROOT}/PayUIndia-AssetLibrary/PayUAssetLibraryKit/PayUAssetLibraryKit.xcframework" "PayUAssetLibraryKit" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"

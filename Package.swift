...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "PayUIndia-AssetLibrary",url: "https://github.com/payu-intrepos/PayUAssetLibrary-iOS", from: "3.0.0"),
        .package(name: "PayUIndia-PG-SDK",url: "https://github.com/payu-intrepos/iOS-SDK", .exact("7.1.0")),
        .package(name: "PayUIndia-Custom-Browser",url: "https://github.com/payu-intrepos/iOS-Custom-Browser", .exact("8.0.0")),
        .package(name: "PayUIndia-NativeOtpAssist",url: "https://github.com/payu-intrepos/PayUNativeOtpAssist-iOS", from: "2.0.0"),
        .package(name: "SocketIO", url: "https://github.com/ShubhGar/socket.io-client-swift", from: "17.0.0"),

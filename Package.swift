...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "PayUIndia-PayUParams",url: "https://github.com/payu-intrepos/payu-params-iOS.git", from: "4.4.0"),
        ...
        .package(name: "PayUIndia-AssetLibrary",url: "https://github.com/payu-intrepos/PayUAssetLibrary-iOS.git", from: "3.2.0"),
        .package(name: "PayUIndia-PG-SDK",url: "https://github.com/payu-intrepos/iOS-SDK.git", from: "8.7.0"),
        .package(name: "PayUIndia-Custom-Browser",url: "https://github.com/payu-intrepos/iOS-Custom-Browser.git", from: "9.1.2"),
        .package(name: "PayUIndia-NativeOtpAssist",url: "https://github.com/payu-intrepos/PayUNativeOtpAssist-iOS.git", from: "2.1.2"),
        .package(name: "PayUIndia-UPIKit",url: "https://github.com/payu-intrepos/payu-upi-ios-sdk.git", from: "7.0.0"),

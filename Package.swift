...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "PayUIndia-PayUParams",url: "https://github.com/payu-intrepos/payu-params-iOS.git", from: "3.2.1"),
        ...
        .package(name: "PayUIndia-PG-SDK",url: "https://github.com/payu-intrepos/iOS-SDK.git", .exact("8.1.1")),
        .package(name: "PayUIndia-Custom-Browser",url: "https://github.com/payu-intrepos/iOS-Custom-Browser.git", .exact("9.0.1")),
        .package(name: "PayUIndia-NativeOtpAssist",url: "https://github.com/payu-intrepos/PayUNativeOtpAssist-iOS.git", from: "2.1.1"),
        .package(name: "PayUIndia-UPIKit",url: "https://github.com/payu-intrepos/payu-upi-ios-sdk.git", .exact("6.0.2")),
    ],
    targets: [

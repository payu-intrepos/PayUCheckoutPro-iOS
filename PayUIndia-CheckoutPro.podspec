Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = 'PayUCheckoutPro/PayUCheckoutProKit.framework'

  s.dependency            'PayUIndia-CheckoutProBase', '2.0.0-beta1'
  s.dependency            'PayUIndia-AssetLibrary', '2.0.0-beta1'
  s.dependency            'PayUIndia-PG-SDK', '5.0.0'

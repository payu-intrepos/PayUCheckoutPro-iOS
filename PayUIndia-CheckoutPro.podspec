Pod::Spec.new do |s|
  ...
  s.dependency            'PayUIndia-CheckoutProBase', '~> 7.4'
  s.dependency            'PayUIndia-AssetLibrary', '~> 3.3'
  s.dependency            'PayUIndia-PG-SDK', '~> 10.3'
  s.dependency            'PayUIndia-UPICore', '~> 9.0'
  ...
  s.dependency            'PayUIndia-NativeOtpAssist', '~> 3.2'

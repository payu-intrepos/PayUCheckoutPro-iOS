Pod::Spec.new do |s|
  ...
  s.dependency            'PayUIndia-CheckoutProBase', '8.3.0-alpha.1'
  s.dependency            'PayUIndia-AssetLibrary', '~> 4.0'
  s.dependency            'PayUIndia-PG-SDK', '11.2.0-alpha.1'
  s.dependency            'PayUIndia-UPICore', '10.2.0-alpha.1'
  s.dependency            'PayUIndia-Custom-Browser', '~> 11.0'
  ...
  s.dependency            'PayUIndia-NativeOtpAssist', '~> 4.0'

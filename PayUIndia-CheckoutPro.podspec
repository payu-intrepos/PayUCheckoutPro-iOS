Pod::Spec.new do |s|
  ...
  s.dependency            'PayUIndia-CheckoutProBase', '~> 4.0'
  s.dependency            'PayUIndia-AssetLibrary', '~> 3.0'
  s.dependency            'PayUIndia-PG-SDK', '~> 7.0'
  s.dependency            'PayUIndia-UPICore', '~> 6.0'
  ...
  s.dependency            	'PayUIndia-NativeOtpAssist', '~> 2.0'

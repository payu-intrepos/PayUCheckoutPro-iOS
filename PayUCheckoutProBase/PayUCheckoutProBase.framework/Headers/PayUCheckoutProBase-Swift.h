...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayUCheckoutProBase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19PayUCheckoutProBase15BaseAPIResponse")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase9BaseLayer")
@interface BaseLayer : NSObject
@property (nonatomic, strong) PayUPaymentParams * _Nonnull basePaymentParam;
...
- (nonnull instancetype)initWithPaymentParam:(PayUPaymentParams * _Nonnull)paymentParam OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase13PaymentOption")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase4CCDC")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase24CheckEligibilityResponse")
@interface CheckEligibilityResponse : BaseAPIResponse
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19PayUCheckoutProBase3EMI")
@interface EMI : CCDC
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase26FetchPaymentOptionResponse")
@interface FetchPaymentOptionResponse : BaseAPIResponse
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19PayUCheckoutProBase10ImageParam")
@interface ImageParam : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19PayUCheckoutProBase10NetBanking")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase8NextStep")
@interface NextStep : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP19PayUCheckoutProBase36OnePayUBaseIndividualPaymentDelegate_")
@protocol OnePayUBaseIndividualPaymentDelegate
- (void)upiCollectTransactionRemainingTime:(NSInteger)remainingTime;
@end


SWIFT_PROTOCOL("_TtP19PayUCheckoutProBase24OnePayUBaseLayerDelegate_")
@protocol OnePayUBaseLayerDelegate
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase17PayUPaymentParams")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase11PaymentMode")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase9SavedCard")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase3UPI")
...
SWIFT_CLASS("_TtC19PayUCheckoutProBase6Wallet")
